...
<html lang="en">
  <head>
    <title>Contact us: Salon Management System</title>
...
?>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><!-- do php   echo $row['PageDescription']; -->
                Khagual road, Danapur, Patna.
              </p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="tel://1234567920">+ 94704 00000
                <!-- do php   echo $row['MobileNumber']; -->
              </a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
