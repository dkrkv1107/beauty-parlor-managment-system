...
<html lang="en">
  <head>
    <title>Home: Salon Management System</title>
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">The Queen Salon</span>
			            <h1 class="mb-4">Women's Salon</h1>
			            <p class="mb-4">We take the joy of providing customers with best services in Danapur, Patna.</p>
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">The Queen Salon</span>
			            <h1 class="mb-4">Salon, Spa & Makeup Studio</h1>
			            <p class="mb-4">Skin, Hair and Nail Care Facilities Available. Massage, Facials, Hair-cut, Shampoo, Smoothnening, Straightning, Threading, Waxing and Other facilities available. Also for kids.</p>
    			...
    			<div class="one-forth d-flex align-items-end">
    				<div class="text">
    					...
    					<div class="appointment-wrap">
    						<span class="subheading">Reserve your Time</span>
